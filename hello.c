...
MODULE_AUTHOR("Oleh Dziuba");
MODULE_DESCRIPTION("Labwork num 6");
MODULE_LICENSE("Dual BSD/GPL");

static unsigned int num_greetings = 1;

module_param(num_greetings, uint, S_IRUGO);

MODULE_PARM_DESC(num_greetings, "How many times 'Hello, World!' string will be printed");
...
{
    if (num_greetings == 0 || (num_greetings >= 5 && num_greetings <= 10)) {
